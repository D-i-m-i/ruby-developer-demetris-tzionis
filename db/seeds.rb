...
product4 = Product.create!(title: "Blender 9000", short_description: "Will it blend? Yes", description: "Keep your rare metals away from this ferocious blender; if you make the mistake to throw them in you can bye-bye them.", user: user1)
